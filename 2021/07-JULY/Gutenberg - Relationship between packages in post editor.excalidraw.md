...
---
#post-editor #dependencies #components #wordpress-data #redux
Extracted from this Gutenberg PR: https://github.com/WordPress/gutenberg/pull/32921
...
@wordpress/edit-post ^j9DM93kv

@wordpress/data ^OKi1Fiin

@wordpress/apiFetch ^zXw2Xk9j

@wordpress/block-editor ^bRLphNh5

retrieve 
edited
 post ^F6WCvoCA

@wordpress/blocks ^pPniDTwD

parse post content 
as blocks ^kkPFaR7F

render block list to 
edit parsed content ^7eR7Y9Af

edited blocks ^jlFje0AH
...
Initialize 
the post editor ^rrWNdeG4

@wordpress/editor ^W3UrF5Ng

serialize blocks 
to post content ^cC5X7fc0

Render components 
to edit post properties ^7CWBHoD8

make edits 
to the post ^xEVB9YDi

save changes ^epzL7v81

@wordpress/components ^sBjsrirX

Use reusable 
components 
to render UI ^jmkuMMrR
...
```json
{
	...
	"elements": [
		...
		},
		{
			...
			"rawText": "@wordpress/block-editor",
			"baseline": 13,
			"textAlign": "center",
			"verticalAlign": "top"
		},
